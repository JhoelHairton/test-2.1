        ...
        stage('Clone') {
            steps {
                timeout(time: 2, unit: 'MINUTES'){
                    git branch: 'main', credentialsId: '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', url: 'https://github.com/JhoelHairton/test-2.1.git'
                }
            }
        }
        stage('Build') {
